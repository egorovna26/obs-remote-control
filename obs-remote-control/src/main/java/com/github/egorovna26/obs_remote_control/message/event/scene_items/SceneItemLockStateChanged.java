...
public class SceneItemLockStateChanged extends Event<SceneItemLockStateChanged.Data> {
    /**
    ...
    public boolean isSceneItemLocked() {
        return getData().getEventData().isSceneItemLocked();
    }

    /**
     * SceneItemLockStateChanged Event Data
     */
    @NoArgsConstructor
    @AllArgsConstructor
    @Getter
