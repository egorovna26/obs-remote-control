...
public class SceneItemRemoved extends Event<SceneItemRemoved.Data> {
    /**
     * @return Name of the scene the item was removed from
     */
    ...
    /**
     * @return UUID of the scene the item was removed from
     */
