...
public class InputActiveStateChanged extends Event<InputActiveStateChanged.Data> {
    /**
    ...
    public boolean isVideoActive() {
        return getData().getEventData().isVideoActive();
    }

    /**
     * InputActiveStateChanged Event Data
     */
    @NoArgsConstructor
    @AllArgsConstructor
    @Getter
